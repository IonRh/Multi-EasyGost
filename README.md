...
* 启动脚本
  ```
  wget --no-check-certificate -O gost.sh https://ghproxy.badking.pp.ua/https://raw.githubusercontent.com/kwxos/Multi-EasyGost/master/gost.sh && chmod +x gost.sh && ./gost.sh
  ```
